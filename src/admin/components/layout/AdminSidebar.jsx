...
const AdminSidebar = ({ isOpen, onClose }) => {
  return (
    <aside className={`fixed top-0 left-0 h-screen w-64 bg-blue-100 text-gray-800 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out md:relative md:translate-x-0`}>
